...
export const subServices: SubServiceMeta[] = [
  ...
  // ---------- E-commerce platforms (dedicated landing sub-services) ----------
  {
    slug: "salla",
    parentSlug: "web",
    title: ls("تصميم وتطوير متاجر سلة", "Salla Store Design & Development"),
    shortLabel: ls("متاجر سلة", "Salla Stores"),
    metaTitle: ls(
      "تصميم متجر سلة احترافي وتخصيص كامل | فكرة",
      "Professional Salla Store Design & Customization | Fikra",
    ),
    metaDescription: ls(
      "تأسيس وتخصيص متاجر سلة: ثيم مخصص، بوابات دفع وشحن، تتبع تحويلات، وربط مع تيك توك وميتا وجوجل لزيادة المبيعات.",
      "Salla store setup and customization: custom theme, payments & shipping, conversion tracking, and TikTok/Meta/Google integrations to grow sales.",
    ),
    intro: ls(
      "نؤسس لك متجر سلة جاهز للبيع من اليوم الأول: ثيم مخصص يعكس هويتك، صفحات منتج محسّنة للتحويل، إعداد بوابات الدفع وشركات الشحن السعودية، وربط كامل لتتبع المبيعات على ميتا وتيك توك وجوجل.",
      "We launch a sell-ready Salla store: custom-branded theme, conversion-optimized product pages, full Saudi payments & shipping setup, and complete sales tracking across Meta, TikTok and Google.",
    ),
    highlights: ll(
      [
        "ثيم سلة مخصص بهوية علامتك",
        "صفحات منتج وفئة محسّنة للتحويل",
        "إعداد الدفع والشحن المحلي",
        "ربط TAP وHyperPay وApple Pay",
        "تتبع تحويلات Meta + TikTok + Google",
        "هجرة المنتجات من منصة أخرى",
      ],
      [
        "Custom-branded Salla theme",
        "Conversion-optimized product & category pages",
        "Local payments & shipping setup",
        "TAP, HyperPay, Apple Pay integrations",
        "Meta + TikTok + Google conversion tracking",
        "Product migration from another platform",
      ],
    ),
    process: [
      { step: ls("التخطيط", "Plan"), detail: ls("تحديد متطلبات المتجر والكتالوج والتكاملات.", "Define store requirements, catalog and integrations.") },
      { step: ls("التصميم", "Design"), detail: ls("ثيم مخصص يعكس هويتك ويرفع التحويل.", "Custom theme that reflects your brand and lifts conversion.") },
      { step: ls("الإعداد", "Setup"), detail: ls("منتجات، فئات، دفع، شحن، شحنات استرجاع، فاتورة ضريبية.", "Products, categories, payments, shipping, returns, VAT invoicing.") },
      { step: ls("الإطلاق", "Launch"), detail: ls("اختبار شامل، تدريب الفريق، ثم النشر الرسمي.", "Full testing, team training, then go-live.") },
    ],
    deliverables: ll(
      ["متجر سلة جاهز للبيع", "ثيم مخصص", "تتبع تحويلات كامل", "تدريب الإدارة + دليل تشغيل"],
      ["Sell-ready Salla store", "Custom theme", "Full conversion tracking", "Admin training + ops guide"],
    ),
    faqs: [
      { q: ls("هل تشتغلون على باقة سلة المجانية؟", "Do you work on Salla's free plan?"), a: ls("يفضّل باقة مدفوعة لفتح التخصيص الكامل، وننصحك بالباقة الأنسب لحجمك قبل البدء.", "A paid plan unlocks full customization — we'll advise the right tier for your size before starting.") },
      { q: ls("هل تنقلون متجري من منصة ثانية؟", "Can you migrate my store from another platform?"), a: ls("نعم، ننقل المنتجات والفئات والعملاء والطلبات من Zid أو Shopify أو WooCommerce.", "Yes — we migrate products, categories, customers and orders from Zid, Shopify or WooCommerce.") },
      { q: ls("كم يستغرق إطلاق المتجر؟", "How long until launch?"), a: ls("من 14 إلى 30 يوم حسب حجم الكتالوج والتخصيص المطلوب.", "14 to 30 days depending on catalog size and customization scope.") },
    ],
    plans: [
      subPlan(
        "salla-launch", "إطلاق سلة", "Salla Launch",
        "تأسيس متجر بهوية بسيطة حتى 50 منتج", "Brand basics, up to 50 products",
        3490, 4490,
        ["تخصيص ثيم سلة", "حتى 50 منتج", "إعداد دفع وشحن محلي", "تتبع تحويلات أساسي", "تدريب لمرة واحدة"],
        ["Salla theme customization", "Up to 50 products", "Local payment & shipping setup", "Basic conversion tracking", "One-off training"],
      ),
      subPlan(
        "salla-growth", "نمو سلة", "Salla Growth",
        "متجر متكامل بهوية مخصصة حتى 500 منتج", "Branded store, up to 500 products",
        7990, 9990,
        [
          "ثيم مخصص بهويتك",
          "حتى 500 منتج",
          "بوابات دفع متعددة",
          "ربط شركتي شحن",
          "تتبع Meta + TikTok + Google",
          "صفحة هبوط حملة واحدة",
        ],
        [
          ...
          "Meta + TikTok + Google tracking",
          "1 campaign landing page",
        ],
        true,
      ),
      subPlan(
        "salla-pro", "سلة برو", "Salla Pro",
        "متاجر كبيرة + تكاملات متقدمة", "Large catalogs + advanced integrations",
        14990, 18990,
        [
          "منتجات غير محدودة",
          "تكاملات API مع ERP/CRM",
          "هجرة كاملة من منصة سابقة",
          "تحسين سرعة وCRO",
          "صفحات هبوط متعددة للحملات",
          "دعم مخصص لمدة 3 أشهر",
        ],
        [
          "Unlimited products",
          "API integrations with ERP/CRM",
          "Full migration from a previous platform",
  ...
  },
  {
    slug: "zid",
    parentSlug: "web",
    title: ls("تصميم وتطوير متاجر زد (Zid)", "Zid Store Design & Development"),
    shortLabel: ls("متاجر زد", "Zid Stores"),
    metaTitle: ls(
      "تصميم متجر زد احترافي وتخصيص كامل | فكرة",
      "Professional Zid Store Design & Customization | Fikra",
    ),
    metaDescription: ls(
      "تأسيس وتخصيص متاجر زد: ثيم مخصص، إعداد الدفع والشحن، تتبع تحويلات، وربط ميتا وتيك توك وجوجل.",
      "Zid store setup and customization: custom theme, payments & shipping, conversion tracking, and Meta/TikTok/Google integrations.",
    ),
    intro: ls(
      "متجر زد مبني للبيع بالسوق السعودي: ثيم احترافي بهويتك، إعداد كامل للدفع والشحن المحلي، تكاملات تحويلات متقدمة، وتجربة دفع سريعة تقلّل ترك السلة.",
      "A Zid store built for the Saudi market: branded pro theme, full local payments & shipping setup, advanced conversion tracking, and a fast checkout that cuts cart abandonment.",
    ),
    highlights: ll(
      [
        "ثيم زد مخصص بهويتك",
        "إعداد كامل للدفع والشحن المحلي",
        "تحسين صفحة المنتج والـ Checkout",
        "تتبع تحويلات Meta + TikTok + Google",
        "هجرة من سلة أو Shopify",
      ],
      [
        "Custom-branded Zid theme",
        "Full local payments & shipping setup",
        "Optimized product page & checkout",
        "Meta + TikTok + Google tracking",
        "Migration from Salla or Shopify",
      ],
    ),
    process: [
      { step: ls("التخطيط", "Plan"), detail: ls("تحديد متطلبات المتجر والكتالوج والتكاملات.", "Define store requirements, catalog and integrations.") },
      { step: ls("التصميم", "Design"), detail: ls("ثيم زد مخصص يرفع التحويل ويعكس هويتك.", "Custom Zid theme that lifts conversion and reflects your brand.") },
      { step: ls("الإعداد", "Setup"), detail: ls("منتجات، فئات، دفع، شحن، فاتورة ضريبية.", "Products, categories, payments, shipping, VAT invoicing.") },
      { step: ls("الإطلاق", "Launch"), detail: ls("اختبار شامل وتدريب ثم الإطلاق الرسمي.", "Full testing, training, then go-live.") },
    ],
    deliverables: ll(
      ["متجر زد جاهز للبيع", "ثيم مخصص", "تتبع تحويلات كامل", "تدريب الإدارة"],
      ["Sell-ready Zid store", "Custom theme", "Full conversion tracking", "Admin training"],
    ),
    faqs: [
      { q: ls("أيهما أفضل لي: سلة أم زد؟", "Which is better for me: Salla or Zid?"), a: ls("الاثنان قويان داخل السوق السعودي. نختار حسب طبيعة منتجك، احتياجات الدفع والشحن، ومستوى التخصيص المطلوب.", "Both are strong in the Saudi market. We pick based on your product type, payments & shipping needs, and required customization.") },
      { q: ls("هل تنقلون متجري من منصة أخرى؟", "Can you migrate my store?"), a: ls("نعم، ننقل المنتجات والفئات والعملاء والطلبات من سلة، Shopify أو WooCommerce.", "Yes — we migrate products, categories, customers and orders from Salla, Shopify or WooCommerce.") },
      { q: ls("كم يستغرق إطلاق متجر زد؟", "How long until Zid launch?"), a: ls("من 14 إلى 30 يوم حسب حجم الكتالوج والتخصيص.", "14 to 30 days depending on catalog size and customization.") },
    ],
    plans: [
      subPlan(
        "zid-launch", "إطلاق زد", "Zid Launch",
        "تأسيس متجر حتى 50 منتج", "Setup, up to 50 products",
        3490, 4490,
        ["تخصيص ثيم زد", "حتى 50 منتج", "إعداد دفع وشحن محلي", "تتبع تحويلات أساسي", "تدريب لمرة واحدة"],
        ["Zid theme customization", "Up to 50 products", "Local payment & shipping setup", "Basic conversion tracking", "One-off training"],
      ),
      subPlan(
        "zid-growth", "نمو زد", "Zid Growth",
        "متجر متكامل حتى 500 منتج", "Branded store, up to 500 products",
        7990, 9990,
        [
          "ثيم مخصص بهويتك",
          "حتى 500 منتج",
  ...
  },
  {
    slug: "shopify",
    parentSlug: "web",
    title: ls("تصميم وتطوير متاجر Shopify", "Shopify Store Design & Development"),
    shortLabel: ls("متاجر Shopify", "Shopify Stores"),
    metaTitle: ls(
      "تصميم متجر Shopify احترافي للسوق العربي | فكرة",
      "Professional Shopify Store Design for MENA | Fikra",
    ),
    metaDescription: ls(
      "متاجر Shopify عربية/إنجليزية بثيم مخصص، تكاملات دفع وشحن محلية ودولية، وتتبع تحويلات متقدم.",
      "Bilingual Shopify stores with custom themes, local & international payments & shipping, and advanced conversion tracking.",
    ),
    intro: ls(
      "متجر Shopify سريع وقابل للتوسع، يخدم السوق المحلي والدولي بثيم مخصص ثنائي اللغة، تكاملات دفع محلية ودولية، وتطبيقات مختارة بعناية لرفع متوسط قيمة الطلب.",
      "A fast, scalable Shopify store that serves both local and global markets with a bilingual custom theme, local & global payments, and hand-picked apps that lift AOV.",
    ),
    highlights: ll(
      [
        "ثيم Shopify مخصص ثنائي اللغة (عربي/إنجليزي)",
        "إعداد بوابات الدفع المحلية والدولية",
        "تكامل شركات الشحن المحلية والدولية",
        "اختيار وضبط تطبيقات Shopify الأنسب",
        "تتبع تحويلات Meta + TikTok + Google",
        "هجرة من سلة، زد أو WooCommerce",
      ],
      [
        "Custom bilingual Shopify theme (AR/EN)",
        "Local & international payment gateways",
        "Local & global shipping integrations",
        "Curated Shopify app stack",
        "Meta + TikTok + Google tracking",
        "Migration from Salla, Zid or WooCommerce",
      ],
    ),
    process: [
      { step: ls("التخطيط", "Plan"), detail: ls("اختيار الخطة، الكتالوج، اللغات، والأسواق المستهدفة.", "Pick the plan, catalog, languages and target markets.") },
      { step: ls("التصميم", "Design"), detail: ls("ثيم Shopify مخصص محسّن للتحويل.", "Custom Shopify theme optimized for conversion.") },
      { step: ls("الإعداد", "Setup"), detail: ls("منتجات، تطبيقات، دفع، شحن، ضرائب، Checkout.", "Products, apps, payments, shipping, taxes, checkout.") },
      { step: ls("الإطلاق", "Launch"), detail: ls("اختبار شامل، تدريب، ثم النشر الرسمي.", "Full testing, training, go-live.") },
    ],
    deliverables: ll(
      ["متجر Shopify جاهز للبيع", "ثيم مخصص ثنائي اللغة", "تتبع تحويلات كامل", "تدريب وإدارة"],
      ["Sell-ready Shopify store", "Custom bilingual theme", "Full conversion tracking", "Admin training"],
    ),
    faqs: [
      { q: ls("Shopify أم سلة/زد لمتجري السعودي؟", "Shopify or Salla/Zid for a Saudi store?"), a: ls("سلة وزد أقرب للسوق المحلي بدفع وشحن جاهز. Shopify أنسب لمن يستهدف أسواق دولية أو يحتاج مرونة تطبيقات أكبر.", "Salla and Zid are closer to the local market with ready payments & shipping. Shopify suits stores targeting global markets or needing a broader app ecosystem.") },
      { q: ls("هل تدعمون متاجر متعددة اللغات والعملات؟", "Multi-language & multi-currency stores?"), a: ls("نعم، نُعد Shopify Markets للعملات المتعددة وثيم ثنائي اللغة بالكامل.", "Yes — we set up Shopify Markets for multi-currency and a fully bilingual theme.") },
      { q: ls("كم يستغرق إطلاق متجر Shopify؟", "How long for a Shopify launch?"), a: ls("من 21 إلى 45 يوم حسب التخصيص والتطبيقات والهجرة.", "21 to 45 days depending on customization, apps and migration.") },
    ],
    plans: [
      subPlan(
        "shopify-launch", "إطلاق Shopify", "Shopify Launch",
        "متجر حتى 50 منتج بثيم جاهز معدّل", "Up to 50 products on a tuned theme",
        4990, 5990,
        ["ثيم مدفوع معدّل بهويتك", "حتى 50 منتج", "إعداد دفع وشحن محلي", "Checkout بلغتين", "تتبع تحويلات أساسي"],
        ["Branded paid theme", "Up to 50 products", "Local payment & shipping setup", "Bilingual checkout", "Basic conversion tracking"],
      ),
      subPlan(
        "shopify-growth", "نمو Shopify", "Shopify Growth",
        "متجر متكامل ثنائي اللغة حتى 500 منتج", "Bilingual store, up to 500 products",
        9990, 12490,
        [
          "ثيم مخصص بهويتك",
          "حتى 500 منتج",
        ...
        [
          "Custom-branded theme",
          "Up to 500 products",
          "Local + international payments & shipping",
          "Shopify Markets",
          "Meta + TikTok + Google tracking",
          "1 campaign landing page",
        ],
      ...
      subPlan(
        "shopify-pro", "Shopify Pro", "Shopify Pro",
        "متاجر متقدمة + تكاملات API", "Advanced stores + API integrations",
        18990, 23990,
        [
          "منتجات غير محدودة",
          "تكاملات API مع ERP/CRM",
