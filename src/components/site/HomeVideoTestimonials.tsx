...
const VIDEOS = [
  {
    youtubeId: "",
    nameAr: "عميل في قطاع التجزئة",
    nameEn: "Retail client",
    roleAr: "بإذن العميل سيُنشر الاسم لاحقاً",
    roleEn: "Name shared upon client approval",
    quoteAr: "منهجية شفافة وتقارير أسبوعية — صرنا نقرر بالبيانات.",
    quoteEn: "Transparent methodology and weekly reports — we now decide with data.",
  },
  {
    youtubeId: "",
    nameAr: "عميل في القطاع الصحي",
    nameEn: "Healthcare client",
    roleAr: "بإذن العميل سيُنشر الاسم لاحقاً",
    roleEn: "Name shared upon client approval",
    quoteAr: "الميزانية الإعلانية صارت تشتغل وفق قمع واضح ومؤشرات أداء متفق عليها.",
    quoteEn: "Ad budget now runs against a clear funnel and agreed KPIs.",
  },
  {
    youtubeId: "",
    nameAr: "عميل في القطاع العقاري",
    nameEn: "Real estate client",
    roleAr: "بإذن العميل سيُنشر الاسم لاحقاً",
    roleEn: "Name shared upon client approval",
    quoteAr: "موقع سريع ونظيف، وملاحظات العملاء تحسنت بوضوح.",
    quoteEn: "Fast, clean website with clearly improved customer feedback.",
  },
];
