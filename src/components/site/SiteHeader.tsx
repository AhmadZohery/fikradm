                  ...
                  >
                    ...
                    {isOpen && (
                      <div className="absolute start-0 top-full z-50 pt-2">
                        <div className="grid w-[min(92vw,720px)] grid-cols-1 gap-0 overflow-hidden rounded-3xl border border-border bg-popover/98 shadow-pop backdrop-blur-xl animate-mega-in lg:grid-cols-[1fr_2fr]">
                          {/* Sidebar promo */}
